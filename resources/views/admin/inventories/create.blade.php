...
<div class="card">
    <div class="card-header">
        <h5>Tambah Inventory</h5>
    </div>
    <div class="card-block">
        <form method="post" action="{{url('admin/inventory')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group pull-right">
                <a href="{{route('inventory.index')}}" class="btn btn-success btn-outline-success btn-sm">Kembali</a>
