...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5>Edit Galeri Foto</h5>
        </div>
        <div class="card-block">
            <form method="post" action="{{url('photo',$photo->id)}}" enctype="multipart/form-data">
                @csrf
				@method('patch')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        @enderror" id="title" placeholder="Masukkan judul.." value="{{$photo->title}}">
                        @error('title')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="5" cols="5" class="form-control" placeholder="Default textarea" name="description" id="description">{{$photo->description}}</textarea>
                    </div>
                </div>
